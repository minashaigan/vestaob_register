...
;( function( window ) {
    ...
    FForm.prototype._addControls = function() {
        ...
        this.ctrlContinue = createElement( 'button', { cName : 'fs-continue', inner : '<span class="btn-show">بعدی</span>', appendTo : this.ctrls } );
    ...
    FForm.prototype._validade = function() {
        var fld = this.fields[ this.current ],
            ...
            er;
        var inputs=[];
        $(fld).children(":input[required]").each(function () {
            var input=this, error;
                ...
                case 'input' :
                    if( input.type === 'radio' || input.type === 'checkbox' ) {
                        ...
                        if( input.value === '' ) {
                            ...
                            var re = validateEmail(input.value);
                            if(!re){
                                error= 'INVALIDEMAIL'
                            }
                        }
    ...
    FForm.prototype._showError = function( err ) {
        ...
        switch( err ) {
            case 'NOVAL' :
                message = 'قسمت های ستاره دار حتما باید پر بشن.';
                break;
            case 'INVALIDEMAIL' :
                message = 'ایمیلی که وارد کردی معتبر نیست، دوباره چکش کن.';
                break;
            // ...
        };
